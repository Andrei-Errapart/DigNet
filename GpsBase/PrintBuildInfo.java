...
class PrintBuildInfo {
	...
	public static void main(String[] args) {
		...
		BooleanOption b_options[] = {
			new BooleanOption("logToSerial", "Output log to the serial port 3? Default is false.", false),
			new BooleanOption("logToServer", "Output log to the server connection? Default is true.", true)
		};

		StringOption s_options[] = {
			new StringOption("application", "Application, one of \"GpsBase\", \"ModemBox\". Default is \"GpsBase\"", "GpsBase"),
		};
		...
		println("// vim: ts=4 ");
		println("");
		println("package com.errapartengineering.DigNet; ");
		...
		// print_option("logToSerial", "output log to serial?", have_log_to_serial);
		// println("	// output log to serial ?");
		// println("	public final static boolean	logToSerial = " + (have_log_to_serial ? "true" : "false") + ";");
